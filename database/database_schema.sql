...
CREATE TABLE IF NOT EXISTS orders (
    ...
    payment_status ENUM('pending', 'awaiting_confirmation', 'processing', 'completed', 'failed', 'refunded') DEFAULT 'pending',
    payment_verified_at TIMESTAMP NULL DEFAULT NULL,
    payment_verification_notes TEXT,
    payment_reference VARCHAR(255),
    payment_reminder_count INT DEFAULT 0,
    payment_reminder_last_sent_at TIMESTAMP NULL DEFAULT NULL,
